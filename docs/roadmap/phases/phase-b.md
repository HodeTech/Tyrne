...
1. **ADR-0033 + the kernel-in-every-AS implementation**, plus the per-task `TTBR0_EL1` swap on context switch going live (the T-018 activation differ-path that short-circuits in v1).
