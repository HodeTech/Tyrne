...
| 2026-05-28 | B4 closure retrospective — Task loader (T-019 `load_image` → `LoadedImage`); ADR-0029 + the 2026-05-22 master-review interlude (4 Blocker / 18 Major full-tree audit) + PR #32 remediation closing 23/24 verified findings; ADR-0036 supersession of GICv3/SMMUv3; UNSAFE-2026-0027 + 0028 added, 0025/0026 lifted; HodeTech org migration | [2026-05-28-B4-closure.md](2026-05-28-B4-closure.md) |
