...
## English-only spot-check (per [docs/standards/localization.md](../../../../standards/localization.md))
...
| File:line | Use |
|---|---|
| [`docs/analysis/tasks/phase-b/T-009-timer-init-cntvct.md:109`](../../../../analysis/tasks/phase-b/T-009-timer-init-cntvct.md) | "Second-read review surfaced three Yüksek findings…" |
| [`docs/analysis/tasks/phase-b/T-009-timer-init-cntvct.md:110`](../../../../analysis/tasks/phase-b/T-009-timer-init-cntvct.md) | "Review 1's Yüksek #1 was only half addressed…" |
...
| [`docs/audits/unsafe-log.md:263`](../../../../audits/unsafe-log.md) | "Closes the runtime-check half of Review 1's Yüksek #1…" |
| [`docs/audits/unsafe-log.md:271`](../../../../audits/unsafe-log.md) | "the second-read review's Yüksek #1 explicitly asked for…" |
...
- Module-path identifier: `tyrne_hal::timer::ticks_to_ns` (snake-case) — appears once at [`docs/analysis/tasks/phase-b/T-009-timer-init-cntvct.md:109`](../../../../analysis/tasks/phase-b/T-009-timer-init-cntvct.md#L109); correct Rust path form for the `tyrne-hal` crate.
